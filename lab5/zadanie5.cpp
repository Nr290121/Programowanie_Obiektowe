...
class Osoba: public IDrukowalne{
    private:
        string imie="";
        string nazwisko="";
    public:
...
class Stazysta: public Osoba{
    ...
    public:
        ...
        string PrzedstawSie(){
            return "Stazysta: "+getImie()+" "+getNazwisko()+" "+to_string(getIdPracownika());
        }
};
    ...
    public:
        ...
        void loop(){
            ...
            while(wybor!=8){
                ...
                {
                    case 1:
                        cout << "Kogo chcesz dodac(1-Student,2-Student Zaoczny,3-Stazysta):";
                        cin >> kto;
                        if(kto==1){
