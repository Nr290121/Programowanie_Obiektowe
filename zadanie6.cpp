...
class Osoba: public ISerializable{
    ...
    public:
        ...
        string Serialize(){
            return "Osoba: "+getImie()+" "+getNazwisko();
        }
...
class Student: public Osoba{
    ...
    public:
        ...
        string Serialize(){
            return "Student: "+getImie()+" "+getNazwisko()+" "+to_string(getNrIndeks());
        }
};
...
class StudentZaoczny: public Student{
    public:
        string Serialize(){
            return "Student Zaoczny: "+getImie()+" "+getNazwisko()+" "+to_string(getNrIndeks());
        }
};
...
class Prowadzacy: public Osoba{
    ...
    public:
        ...
        string Serialize(){
            return "Prowadzacy: "+getImie()+" "+getNazwisko()+" "+to_string(getIdPracownika());
        }
};
...
class InterfejsUzytkownika{
    public:
        ...
        void loop(){
            ...
            while(wybor!=9){
                ...
                {
                    case 1:
                        cout << "Kogo chcesz dodac(1-Student, 2-Student Zaoczny, 3-Prowadzacy):";
                        cin >> kto;
                        if(kto==1){
                            ...
                            StudentZaoczny* podana2 = new StudentZaoczny();
                            cout << "Podaj numer indeksu:";
                            cin >> indeks;
                            podana2->setNrIndeks(indeks);
                            cout << "Podaj imie:";
                            cin >> tekst;
                            ...
                            Prowadzacy* podana3 = new Prowadzacy();
                            cout << "Podaj numer indeksu:";
                            cin >> indeks;
                            podana3->setIdPracownika(indeks);
                            cout << "Podaj imie:";
                            cin >> tekst;
                            podana3->setImie(tekst);
                            cout << "Podaj nazwisko:";
                            cin >> tekst;
                            podana3->setNazwisko(tekst);
                            dodajOsobe(podana3);
                        }
                        break;
                    ...
                    case 4:
                        cout << "Kogo chcesz zaktualizowac(1-Student, 2-Student Zaoczny, 3-Prowadzacy):";
                        cin >> kto;
                        if(kto==1){
                    ...
                    case 8:
                        int wyborZapisu;
                        cout << "Co chcesz zapisac?(1-jedna osoba, 2-cala lista):";
                        cin >> wyborZapisu;
                        if(wyborZapisu == 1){
                            cout << "Podaj nazwisko osoby ktora chcesz zapisac do pliku:";
                            cin >> nazwisko;
                            for(int i=0; i<iloscOsob; i++)
                                if(tabOsoba[i] && tabOsoba[i]->getNazwisko() == nazwisko)
                                    zapiszDoPliku(tabOsoba[i], "dane.txt");
                        }else{
                            cout << "Podaj numer id listy jaka chcesz zapisac do pliku(0-" << iloscList-1 << "):";
                            cin >> idListy;
                            for(int i=0; i<10; i++)
                                if(tabList[idListy].getOsoba(i))
                                    zapiszDoPliku(tabList[idListy].getOsoba(i), "lista"+to_string(idListy)+".txt");
                        }
                        break;
                }
            }
    ...
    private:
        ...
        void zapiszDoPliku(ISerializable *obj, string nazwa_pliku){
            ofstream plik;
            plik.open(nazwa_pliku, ios::app);
            if(plik.is_open()){
                plik << obj->Serialize() << endl;
                plik.close();
            }
        }
};
